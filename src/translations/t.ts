...
const ar: Translation = {
  ...
  review_need_to_repeat: "تحتاج إلى المراجعة",
  review_right: "لقد تذكرتها بشكل صحيح",
  ...
  ai_speech_preview_instead: "بدلاً من الصوت الروبوتي مثل هذا",
  ai_speech_preview_get: "احصل على صوت عالي الجودة مثل هذا",
  ai_speech_supports: "يدعم جميع اللغات الشهيرة",
...
const fa: Translation = {
  ...
  review_need_to_repeat: "نیاز به مرور",
  review_right: "درست به یاد آوردم",
  ...
  ai_speech_preview_instead: "به جای صدای رباتی مانند این",
  ai_speech_preview_get: "صدای با کیفیت بالا مانند این دریافت کنید",
  ai_speech_supports: "از تمام زبان‌های محبوب پشتیبانی می‌کند",
};
...
const uk: Translation = {
  ...
  ai_speech_preview_instead: "Замість роботизованого голосу, як цей",
  ai_speech_preview_get: "Отримайте якісний голос, як цей",
  ai_speech_supports: "Підтримує всі популярні мови",
  ...
  deck_preview: "Попередній перегляд колоди",
  ...
  review_need_to_repeat: "Потрібно повторити",
  review_right: "Я знаю це",
